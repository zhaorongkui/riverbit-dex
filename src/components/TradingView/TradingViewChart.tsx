      ...
      try {
        ...
        widgetRef.current = new window.TradingView.widget({
          ...
          overrides: {
            ...
            // 下跌K线颜色 - 阴线主体颜色
            'mainSeriesProperties.candleStyle.downColor': '#ef4444', // 红色
            // 上涨K线边框颜色 - 阳线边框
            'mainSeriesProperties.candleStyle.borderUpColor': '#0EECBC', // 绿色边框
            // 下跌K线边框颜色 - 阴线边框
            'mainSeriesProperties.candleStyle.borderDownColor': '#ef4444', // 红色边框
            // 上涨K线影线颜色 - 阳线上影线和下影线
            'mainSeriesProperties.candleStyle.wickUpColor': '#0EECBC', // 绿色影线
            // 下跌K线影线颜色 - 阴线上影线和下影线
            'mainSeriesProperties.candleStyle.wickDownColor': '#ef4444', // 红色影线
          ...
          studies_overrides: {
            // 成交量指标配置
            // 下跌时的成交量颜色 - 对应阴线的成交量柱
            'volume.volume.color.0': 'rgba(239, 68, 68, 0.5)', // 半透明红色
            // 上涨时的成交量颜色 - 对应阳线的成交量柱
